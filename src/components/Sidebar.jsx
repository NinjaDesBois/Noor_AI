...
const NAV = [
  ...
  { to: '/nouveaux-musulmans', label: 'Débuter', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> },
  ...
  return (
    <div className="sidebar">
      ...
      <nav className="snav">
        {NAV.map(({ to, label, icon }) => (
          <NavLink
            ...
            style={({ isActive }) => ({ color: isActive ? 'var(--text-1)' : 'var(--text-4)' })}
          >
            {icon}
      ...
      <NavLink
        to="/settings"
        className={({ isActive }) => `snav-item${isActive ? ' active' : ''}`}
        style={({ isActive }) => ({ color: isActive ? 'var(--text-1)' : 'var(--text-4)', marginTop: 'auto' })}
      >
